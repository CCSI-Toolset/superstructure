...
$CALL  gdxxrw.exe C:\Users\mzamarripa\Documents\Superstructure_project\01_Project_files\SurrogateModels\BUF_surrogates\ADS_BUF_Variables.xlsx @C:\Users\mzamarripa\Documents\Superstructure_project\01_Project_files\SurrogateModels\BUF_surrogates\surrogate_models\parameters_ADS_BUF.txt
$GDXIN ADS_BUF_Variables.gdx
$LOAD i
...
+ xf('3') * (
         +a1('3')*gasInF(i)**a('3') - a2('3') * gasInH2O(i)**b('3') *gasInCO2(i)**c('3')
          )
...
+ xf('4') * (
         +a1('4') + a2('4')*log(GasInT(i))
         + a3('4')*(Dt(i)**a('4'))*(GasInCO2(i)**b('4'))
         + a4('4')*(GasInH2O(i)**c('4'))*(lhx(i)**d('4'))
                 )
...
+xf('6')* (  -a1('6') * log((gasInCO2(i)) + a2('6') * gasInH2O(i)**a('6') + solidInH2O(i)**b('6') )    )
...
+xf('9')*( (a1('9') * GaSInCO2(i)**a('9')) + a2('9')*Dt(i)**b('9') )
...
*a1.l('3')=1241.6;  a2.l('3')=35637;
a.l('3')=1; b.l('3')=1; c.l('3')=1;
...
model leastconst /func,Value,c5,obj2/
...
minv=smin(i,val.l(i));
maxv=smax(i,val.l(i));
*display SE.l, SEM.l, R2.l,minv,maxv,estim;
...
Execute_unload "ADS_BUF_Results.gdx" ParR2, Parminv, Parmaxv, ParA, ParB, ParC, ParD, ParA1, ParA2, ParA3, ParA4, time;
...
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParR2.l rng=R2!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=Parminv.l rng=Parminv!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=Parmaxv.l rng=Parmaxv!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParA.l rng=ParA!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParB.l rng=ParB!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParC.l rng=ParC!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParD.l rng=ParD!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParA1.l rng=ParA1!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParA2.l rng=ParA2!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParA3.l rng=ParA3!'
Execute 'gdxxrw.exe ADS_BUF_Results.gdx Squeeze=N par=ParA4.l rng=ParA4!'
